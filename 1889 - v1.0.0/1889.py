...
import sys
from STALKCLASS import Option_S1
...
def main():
    while True:
        ...
        console.print("[bold white] Coming Soon\n\n")

        console.print("[bold red]══ [bold yellow]STALK CLASS\n")
        console.print("[bold yellow][ S1 ] Start 1889 Stalk Class Tech\n\n")

        console.print("[bold red]══ [bold green]HACKER CLASS\n")
        console.print("[bold white] Coming Soon\n\n")
